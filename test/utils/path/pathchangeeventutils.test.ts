...
import { PathChangeEventUtils, PathEventComparisonEnum } from "../../../src/utils/path/pathchangeeventutils";
...
describe("pathchangeeventutils", () => {
    ...
    it("same path old ev is add", () => {
        ...
        expect(PathChangeEventUtils.compareEvents(oldAddEv, addEv)).to.be.equal(PathEventComparisonEnum.Inconsistent);
