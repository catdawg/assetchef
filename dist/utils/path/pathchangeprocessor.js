 ...
 */
function processOne(queue, handler, logger = winstonlogger_1.default, _debugActionAfterProcess = () => { return; }) {
 ...
 */
function processAll(queue, handler, logger = winstonlogger_1.default) {
    return __awaiter(this, void 0, void 0, function* () {
        let res;
        while ((res = yield processOne(queue, handler, logger)).processed) {
            continue;
        }
        return res;
    });
