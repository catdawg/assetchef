...
/**
 * Logs the parameters to the console with the debug category. Arguments are like {@link https://nodejs.org/api/util.html#util_util_format_format_args|link util.format}
 * This should support objects with cycles.
 * @param {...any} args - {@link https://nodejs.org/api/util.html#util_util_format_format_args|link util.format} type args.
 * @returns {void}
 */
logger.logDebug = function (...args) {
