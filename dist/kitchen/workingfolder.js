...
class WorkingFolderUtils {
     ...
     */
    static setup(logger, workingFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const versionFile = pathutils.join(workingFolder, defines_1.ASSETCHEF_FOLDER_VERSION_FILE);
            try {
                yield fse.writeFile(versionFile, Buffer.from(defines_1.ASSETCHEF_FOLDER_VERSION));
            }
            catch (e) {
     ...
     * @returns true if successful
     */
    static delete(logger, workingFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            if (logger == null) {
                throw new verror_1.default("logger can't be null");
            }
     ...
     */
    static check(logger, workingFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            if (logger == null) {
                throw new verror_1.default("logger can't be null");
            }
            ...
            const workingFolderVersionFile = pathutils.join(workingFolder, defines_1.ASSETCHEF_FOLDER_VERSION_FILE);
            ...
            if (existingVersion.toString("utf8") !== defines_1.ASSETCHEF_FOLDER_VERSION) {
                logger.logInfo(".assetchef folder is older '%s' than current version '%s'.", existingVersion, defines_1.ASSETCHEF_FOLDER_VERSION);
                return CheckWorkingFolderResultType.OutOfDate;
            }
            return CheckWorkingFolderResultType.Success;
        });
    }
    static _setTestInterrupt(f) {
        _interrupt = f;
    }
}
exports.WorkingFolderUtils = WorkingFolderUtils;
